...
def getsample(size, logM200_Msun_min=12.0, logM200_Msun_max=12.5, seed=0):
    ...
    Mh_names =['geq{}_le{}'%(logM200_Msun_min,logM200_Msun_max)]

    sel = Galaxyselector(halocat, selections=Mh_sels, names=Mh_names,\
...
def create_histogram():
    ...
    hist, edges = combine_hists(hist, temp, edges, edges_temp,
